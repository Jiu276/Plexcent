    ...
    return `
        <article class="post-card" data-post-id="${post.id}">
            ...
            <div class="post-content">
                ...
                <h2 class="post-title">
                    <a href="#" onclick="openArticle(${post.id}); return false;">${post.title}</a>
                </h2>
                    ...
                    <article class="article-content">
                        ...
                        <div class="article-footer">
                            ...
                            <div class="share-buttons">
                                ...
                                <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}" target="_blank" class="share-btn twitter">
